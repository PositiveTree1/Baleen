      ...
      {isOpen && (
        ...
        >
          ...
          >
            {/* Header */}
            {title ? (
              <div className="flex justify-between items-center px-5 sm:px-6 py-4 border-b border-slate-200 bg-slate-50/80 shrink-0">
                <div className="pr-4">
                  <h3
                    id={titleId}
                    className="text-sm sm:text-base font-bold text-slate-950 tracking-tight"
                  >
                    {title}
                  </h3>
                  {subtitle && (
                ...
                {!hideCloseButton && (
                  <button
                    ...
                    className="w-8 h-8 rounded-full flex items-center justify-center text-slate-500 hover:text-slate-900 hover:bg-slate-100 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-sky-500/40 ml-auto shrink-0 cursor-pointer"
                  >
              ...
              <button
                ...
                onClick={onClose}
                aria-label="Close dialog"
                className="absolute top-4 right-4 z-20 w-8 h-8 rounded-full flex items-center justify-center text-slate-500 hover:text-slate-900 hover:bg-slate-100 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-sky-500/40 cursor-pointer"
              >
                <X size={16} aria-hidden="true" />
              </button>
            ) : null}
            ...
            <div
              className={
                contentClassName ??
                'p-5 sm:p-6 text-slate-950 overflow-y-auto overscroll-contain flex-1'
              }
            >
              {children}
            </div>
