...
export function Hero() {
  return (
    <section className="relative min-h-[80vh] sm:min-h-[84vh] flex items-center px-4 sm:px-6 lg:px-20 overflow-hidden bg-[#F8F9FB] dark:bg-[#000000] transition-colors duration-150">
        ...
        <div className="max-w-xl sm:max-w-2xl flex flex-col items-start gap-6 sm:gap-7">
          ...
          >
            <Link href="/auth/signup">
              <button 
                className="flex items-center gap-2.5 px-8 py-4 rounded-full bg-slate-950 dark:bg-white text-white dark:text-black hover:bg-slate-800 dark:hover:bg-slate-200 text-sm font-bold transition-all shadow-md active:scale-[0.98] cursor-pointer group focus:outline-none focus-visible:ring-2 focus-visible:ring-[#00D09C] focus-visible:ring-offset-2 focus-visible:ring-offset-[#F8F9FB] dark:focus-visible:ring-offset-black"
                aria-label="Get Started with Baleen copy-trading"
              >
